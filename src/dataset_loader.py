...
class EWSDataset(Dataset):
    ...
    def __init__(self, X, y, length, augment, aug_cfg, pad_mode="zero"):
    ...
    def __getitem__(self, idx):
        ...
        if self.augment:
            ...
            out = make_model_input(series, self.length, pad_mode=self.pad_mode)
        else:
...
def get_dataloader(
    ...
    dataset  = EWSDataset(X, y, target_length, augment, aug_cfg, pad_mode=pad_mode)
