"""
models/tde.py — TemporalDictionaryEnsemble wrapper (nn-dataset Net pattern).
...
class TDENet:
    """Net wrapper around aeon TemporalDictionaryEnsemble."""
    ...
    def __init__(self, ts_len: int, num_classes: int, **kwargs):
        ...
        self._clf = TemporalDictionaryEnsemble(**hp)
        self._classes = None

    @classmethod
    def supported_hyperparameters(cls):
        return [{"n_parameter_samples": 250, "n_jobs": 8}]
